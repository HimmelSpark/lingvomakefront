                ...
                <v-card>
                    ...
                    <v-card-actions>
                        ...
                        <v-dialog v-model="deleteDialog" persistent max-width="290">
                            <v-card>
                                <v-card-title class="headline">Do you want to delete this group?</v-card-title>
                                <v-card-text>This process is irreversible, you can't restore this student
                                    later!</v-card-text>
                                <v-card-actions>
                                    <v-spacer></v-spacer>
